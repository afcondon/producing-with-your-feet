...
main = do
  ...
  let idle n = { index: n, state: "idle", layers: 0, loopFrames: 0, loopSecs: 0.0
               ...
               , winIn: 0, winOut: 0, rot: 0, pendingAt: -1, recFrames: 0, shapes: [] }
  ...
  assert "capture and save spell as the daemon expects"
    (LoopVerb.render LoopVerb.ClaimPast == "t"
      ...
      && LoopVerb.render (LoopVerb.LayerWindow 2 1000 625000) == "lw2:1000:625000"
      && LoopVerb.render (LoopVerb.ClearLayerWindow 2) == "lw2"
      && LoopVerb.render (LoopVerb.DupLayer 3) == "dp3")
